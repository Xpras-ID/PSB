...
<p align="left" class="style1 style4"><strong><blink></blink></strong><a href="akunTHN.jsp" target="mainFrame">
  <input name="button" type="button" class="style6" id="button" value="Kembali"/>
</a></p>
<div align="center"><span class="style9"><strong>AKUNTANSI </strong></span></div>
<span class="style9"><blink>
  </blink></span>
<div align="center"><a href="InputData.jsp"></a></div>
<a href="InputData.jsp"><blink></blink></a><a href="InputData.jsp"><blink><div align="left"></div>
</blink></a></p>
<div align="right">
...
<table width="1343" border="0" align="center" cellpadding="0" cellspacing="1">
  
  <tr>
    <td width="77" border="1" bgcolor="#333333"><div align="center" class="style14">Rank</div></td>
    <td width="137" height="15" border="1" bgcolor="#333333"><div align="center" class="style6 style7">
    ...
    <td bordercolor="#FFFFFF" bgcolor="#333333"><div align="center" class="style8 style9 style4">Tahun Ajaran</div></td>
    <td bordercolor="#FFFFFF" bgcolor="#333333"><div align="center"><span class="style14">Keterangan</span></div></td>
  </tr>
   <%	String cari = request.getParameter("cari");
		Class.forName(url); 
		Connection connection = DriverManager.getConnection(koneksi,username,pass);		
		Statement statement =connection.createStatement(); 
		String sql = "select * from View_Ak_Diterima where no_pendaftaran='"+cari+"' OR nama_pendaftar like '%"+cari+"%' OR tahun_ajaran_id like '%"+cari+"%'";
		if (cari == null)		
		sql = " select * from View_Ak_Diterima where tahun_ajaran_id like '%"+cari+"%' ";
  ...
  <tr>
    ...
    <td width="207" bgcolor="#CCCCCC"><div align="center"><span class="style13">
      <% out.print(status);%>
    </span></div></td>
  </tr>
 <%
...
<table width="1344" border="0" align="center" cellpadding="0" cellspacing="1">
   ...
   <%	
		...
		String sql2 = "select * from View_Ak_TdkDiterima where no_pendaftaran='"+cari+"' OR nama_pendaftar like '%"+cari+"%' OR tahun_ajaran_id like '%"+cari+"%'";
		if (cari == null)		
		sql2 = " select * from View_Ak_TdkDiterima where tahun_ajaran_id like '%"+cari+"%'";
